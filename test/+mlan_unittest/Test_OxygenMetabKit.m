classdef Test_OxygenMetabKit < matlab.unittest.TestCase
    %% line1
    %  line2
    %  
    ...
    methods (Test)
        ...
        function test_quadraticKit(this)
            these = mlan.DispersedAerobicGlycolysisKit.construct('cbf', subjectsExpr='sub-S03292-N12', Nimages=1);
            disp(these)
        end
        function test_dispersiveKit(this)
            these = mlan.DispersedAerobicGlycolysisKit2.construct('cbf', subjectsExpr='sub-S03292-N12', Nimages=1);
            disp(these)
        end
